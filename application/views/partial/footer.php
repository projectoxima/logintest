	...
	<!-- SPARKLINES -->
	<script type="text/javascript" src="<?php echo base_url() ;?>js/sparklines/jquery.sparkline.min.js"></script>
	<!-- EASY PIE CHART -->
    ...
    <script src="<?php echo base_url() ;?>js/flot/jquery.flot.selection.min.js"></script>
    ...
    <script src="<?php echo base_url() ;?>js/flot/jquery.flot.crosshair.min.js"></script>
	<!-- TODO -->
	<script type="text/javascript" src="<?php echo base_url() ;?>js/jquery-todo/js/paddystodolist.js"></script>
	<!-- TIMEAGO -->
	<script type="text/javascript" src="<?php echo base_url() ;?>js/timeago/jquery.timeago.min.js"></script>
	<!-- FULL CALENDAR -->
	...
	<!-- GRITTER -->
	<script type="text/javascript" src="<?php echo base_url() ;?>js/gritter/js/jquery.gritter.min.js"></script>
	<!-- CUSTOM SCRIPT -->
